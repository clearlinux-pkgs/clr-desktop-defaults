...
Version  : 7
Release  : 10
URL      : https://github.com/clearlinux/clr-desktop-defaults/releases/download/v7/clr-desktop-defaults-7.tar.xz
Source0  : https://github.com/clearlinux/clr-desktop-defaults/releases/download/v7/clr-desktop-defaults-7.tar.xz
...
%prep
%setup -q -n clr-desktop-defaults-7

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492093875
