...
Version  : 6
Release  : 9
URL      : https://github.com/clearlinux/clr-desktop-defaults/releases/download/v6/clr-desktop-defaults-6.tar.xz
Source0  : https://github.com/clearlinux/clr-desktop-defaults/releases/download/v6/clr-desktop-defaults-6.tar.xz
...
%prep
%setup -q -n clr-desktop-defaults-6

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491835871
