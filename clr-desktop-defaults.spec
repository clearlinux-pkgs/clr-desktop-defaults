...
Version  : 20
Release  : 43
URL      : https://github.com/clearlinux/clr-desktop-defaults/archive/v20.tar.gz
Source0  : https://github.com/clearlinux/clr-desktop-defaults/archive/v20.tar.gz
...
%prep
%setup -q -n clr-desktop-defaults-20
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570563907
